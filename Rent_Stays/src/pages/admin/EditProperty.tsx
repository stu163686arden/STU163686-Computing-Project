...
const utilitiesList = ["Water", "Electricity", "Gas", "Internet", "Cable", "Trash"];
            ...
            try {
                ...
                if (data) {
                    setFormData({
                        ...
                        promotionalPrice: data.promotional_price?.toString() || "",
                    ...
                    setIncludedUtilities(data.included_utilities || []);
                }
            } catch (error: any) {
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="stat-card animate-fade-up stagger-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            <Label htmlFor="sqft">Square Metres *</Label>
                            <Input
                                id="sqft"
                                type="number"
                                value={formData.sqft}
